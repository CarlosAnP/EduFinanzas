...
from .views import (
    ...
    PasswordResetRequestView, PasswordResetConfirmView, CustomTokenObtainPairView, AccountActivateView
)
...
urlpatterns = [
    ...
    path('auth/activate/', AccountActivateView.as_view(), name='account_activate'),
